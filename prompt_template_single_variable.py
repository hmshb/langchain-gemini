...
# Demonstrates This is the example of prompt template with single variable.
...
def main():
    ...
    template = "Extract the key facts from the following text: {text}. Provide a list of the most important points."
    ...
    response = gemini_model.execute_chain(prompt_template=template, input_text=word_to_translate, input_variables=["text"])
